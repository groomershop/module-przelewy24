...
class RegisterTransactionResponseValidator extends AbstractValidator
{
    ...
    public function validate(array $validationSubject): ResultInterface
    {
        ...
        $errors = [];
        $isValid = true;
        if (empty($response[self::TOKEN])) {
            $isValid = false;
            $errors[] = $this->errorFormatter->format('transaction token is missing', $validationSubject);
        }
