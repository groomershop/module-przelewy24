...
use PayPro\Przelewy24\Gateway\Validator\BlikVaultResponseValidator;
use PayPro\Przelewy24\Model\ErrorFormatter;

class BlikVaultResponseValidatorTest extends ValidatorTestCase
{
    public function testValidate(): void
    {
        ...
        $model = new BlikVaultResponseValidator(
